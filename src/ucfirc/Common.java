...
public abstract class Common {
	...
	/**
	 * Returns a 32 character random string with the values in
	 * ALLOWED_CHARACTERS
	 */
	...
	/**
	 * Gets a File for a file with the address stored relative to the user's
	 * home dir in the properties file Warning: The file may be nonexistant
	 * 
	 * @param property
	 *            The property that has the file name
	 * @return The file
	 */
	public static File getFileFromProperty(String property) {

		return new File(Main.properties.getProperty(property));

	}

	/**
	 * Gets an InputStream for a file with the address stored relative to the
	 * user's home dir in the properties file
	 * 
	 * @param property
	 *            The property with the file's name
